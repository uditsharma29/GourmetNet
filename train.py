...
from modeling.gourmetNet import *
...
class Trainer(object):
    def __init__(self, args):
        ...
        # Define network
        model = GourmetNet(num_classes=self.nclass,
        ...
        #dump_input = torch.rand((1, 3, 320, 320))
...
#                                            args.epochs, len(self.train_loader))
        ...
        optimizer, args.lr_step, args.lr_factor,)
        ...
        if args.resume is not None:
            ...
            for k in model_state_dict:
                if k in checkpoint['state_dict'] and model_state_dict[k].size() == checkpoint['state_dict'][k].size():
                    print('Loaded parameter {}'.format(k))
    ...
    def validation(self, epoch, args):
        ...
        mIoU_class = self.evaluator.Intersection_over_Union_Per_Class()
        ...
        print("Acc:{}, Acc_class:{}, mIoU:{}, fwIoU: {}".format(self.best_acc, self.best_acc_class, self.best_pred, self.best_fwiou))
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='unimib',
                        choices=['pascal', 'coco', 'cityscapes', 'foodpix', 'unimib'],
    ...
    parser.add_argument('--lr_step', type=list, default=[40, 70], metavar='LR_STEP',
                        help='Step size of learning rate scheduler')
    parser.add_argument('--lr_factor', type=float, default=0.3, metavar='LR_FACTOR',
